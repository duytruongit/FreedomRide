 ...
 */
public class AttractionsPage extends Page {

	private List<Attractions> content;

	public List<Attractions> getContent() {
		return content;
	}

	public void setContent(List<Attractions> content) {
